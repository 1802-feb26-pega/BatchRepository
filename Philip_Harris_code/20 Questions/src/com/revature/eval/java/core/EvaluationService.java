...
public class EvaluationService {
	...
	public class Triangle {
		...
		public boolean isScalene() {
			// TODO Write an implementation for this method declaration
			if(this.isIsosceles() || this.isEquilateral()) return false;
			else return true;
		}
	...
	public String toPigLatin(String string) {
		// TODO Write an implementation for this method declaration
		if(string.charAt(0)=='a') return string += "ay";
		else if(string.charAt(0)=='e') return string += "ay";
		else if(string.charAt(0)=='i') return string += "ay";
		else if(string.charAt(0)=='o') return string += "ay";
		else if(string.charAt(0)=='u') return string += "ay";
		else string = string.substring(1) + string.charAt(0) + "ay";
		return string;
	}
