...
public class ServiceToUI implements ServiceUIConnector {
        ...
        public BankAccount requestEntryUpdateBalance(BankAccount curr, 
                        BankAccount proposed) {
                who = UserType.updateExisting;
                serviceSend(curr);
                serviceSend(proposed);
        ...
        public BankAccount processEntryCurrentBalance() {
                return processUser();
        }
        
        public BankAccount processEntryProposedBalance() {
                return processUser();
        }
        
        public void finalizeEntryUpdate(BankAccount ba) {
                who = UserType.otherEntry;
                persistSend(ba);
        }
