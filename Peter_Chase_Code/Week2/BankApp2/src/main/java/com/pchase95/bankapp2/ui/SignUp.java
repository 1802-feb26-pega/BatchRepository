...
public class SignUp extends JFrame {
	...
	private void btnSignInClick() {
		...
		boolean validUsername = Sanitizer.sanitizeUsername(username);
		boolean validEmail = Sanitizer.sanitizeEmail(email);
		boolean validPassword = Sanitizer.sanitizePassword(password);
