...
public class ConnectionFactory {
	...
	public Connection getConnection(){
		...
		try{
			...
			String path = "C:/Users/wille_000/Desktop/Revature Classes/BatchRepository/William_Rosser_Code/Week3/bank_demo/src/main/java/com/bank/util/database.properties";
			prop.load(new FileReader(path));
			// register JDBC driver
			System.out.println("property = " + prop.getProperty("url"));
