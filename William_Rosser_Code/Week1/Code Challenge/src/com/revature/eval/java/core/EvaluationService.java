...
//	Done
	public String acronym(String phrase) {
		...
		String words[] = phrase.split("[\\s\\W]");
		String acro = "";
		for (String w:words) {
			acro += w.length() > 0 ? w.substring(0,1): "";
		}
...
//				System.out.println("Comparison to m:" + t.compareTo(sortedList.get(m)));
//				System.out.println("m=" + m + " l=" + l + " r=" + r + " mval=" + sortedList.get(m));
...
//			System.out.println("Returning sucess");
	...
	public Temporal getGigasecondDate(Temporal given) {
		return ((given instanceof LocalDate) ? ((LocalDate) given).atTime(0,0) : given).plus(1000000000, ChronoUnit.SECONDS);
	}
